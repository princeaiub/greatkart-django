...
def cust_check_user_session(request):
...
#         paginator = Paginator(show_in_store,6) # Show 6 feedback entries per page
...
#     return render(request, 'store.html',{"show_in_store":feedbacks_paginated,"product_count":product_count})
def store(request):
...
#     try:
#         show_in_store = paginator.page(page)
#     except PageNotAnInteger:
#         show_in_store = paginator.page(1)
#     except EmptyPage:
#         show_in_store = paginator.page(paginator.num_pages)
